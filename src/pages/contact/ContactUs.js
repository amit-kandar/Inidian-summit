...
import './Contact.css';
import { FACEBOOK, LINKEDIN, MAIL, PHONE_ICON, TWITEER, YOUTUBE } from '../../utils/constant';
...
const ContactUs = () => {
  ...
  return (
    <section className="contactus-background flex items-center justify-center text-black" style={{ height: 'auto' }} id='contact-us'>
      <div className="lg:flex w-3/4 mx-auto my-8">
        <div className="bg-[#663c21] lg:w-[64%] mx-auto px-6 lg:px-16 rounded-l-lg relative opacity-85">
          ...
          <div className="py-6">
            ...
            <div className="lg:flex relative">
              ...
              <div className="w-full lg:w-1/2 px-1 mb-4 z-10">
                <img src={PHONE_ICON} alt="Phone" className="mr-3 h-5" />
            ...
            <div className="w-full px-1 mb-4 relative z-10">
              <label className="text-white font-light">Group or Organization</label>
              <select
                id="categorySelect"
                className="w-full mt-2 px-3 py-2 border rounded-lg text-white focus:outline-none focus:border-green-500"
                style={{ color: '#9ca3af' }}
            ...
            {showOtherOrganizationInput && (
              <div id="other-organization-input" className="w-full px-1 mb-4 relative z-10">
                <label htmlFor="other-organization" className="text-white font-light">
                  Please specify:
                </label>
                <input
                  type="text"
            ...
            <div className="w-full px-1 mb-0.5 relative z-10">
              <label className="text-white font-light">How can I help you?</label>
              <input
                type="text"
                placeholder="Your message"
                className="w-full mt-1 px-2 py-1 border rounded-lg text-white focus:outline-none focus:border-green-500"
              />
            </div>
          </div>
        ...
        <div className="w-full lg:w-[36%] bg-gradient-to-b from-[#0F0806] to-[#4F2B06] rounded-r-lg text-white mobile-height opacity-90">
          <div>
            <div className="font-bold pt-12 pb-3 px-4 text-white text-2xl">Contact us</div>
            ...
            <div className="flex items-center pt-12">
              ...
              <a href="https://www.X.com" target="_blank" rel="noreferrer">
                <img src={TWITEER} className="h-[39px] px-4 mr-6" alt="Twitter" />
              </a>
